...
EXTRAS_REQUIRE = {
    ...
    "openvino": ["openvino-dev==2022.3.0.dev20221103"], # temporarily using pre-release version
    "nncf": ["nncf @ git+https://github.com/vuiseng9/nncf"], # temporarily using pre-release version
